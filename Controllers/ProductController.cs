...
namespace ProductSearch.Controllers
{
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchCategory, string searchString)
        {
            ...
            {
                return Problem("Entity set 'ProductSearch.Product' is null.");
            }
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductName,Size,Price,MfgDate,Category")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ProductName,Size,Price,MfgDate,Category")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
